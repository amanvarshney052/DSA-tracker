...
import { FaCode, FaLock, FaKey } from 'react-icons/fa';
...
function ResetPasswordContent() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await authAPI.resetPassword(password, otp, email);
            setStatus('success');
            ...
            >
                ...
                <div className="bg-white rounded-[40px] p-8 shadow-xl border border-gray-100">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {/* Email Field (Visible but distinct) */}
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-slate-800 focus:outline-none focus:border-primary-500 transition-all"
                                required
                            />
                        </div>
                        ...
                        {/* OTP Field */}
                        <div>
                            <label className="block text-sm font-medium mb-2 text-slate-700">OTP Code</label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-12 pr-4 py-3 text-slate-800 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-all placeholder:text-slate-400 tracking-widest text-lg"
                                    placeholder="123456"
                                    required
                                />
                            </div>
